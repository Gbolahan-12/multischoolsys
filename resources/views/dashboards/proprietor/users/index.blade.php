...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('proprietor.users.create') }}" class="btn btn-primary btn-sm">
                                    ...
                                    <td class="pe-4 text-end">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0">
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('proprietor.users.edit', $user) }}">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('proprietor.users.show', $user) }}">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center py-5 text-muted">
                                        ...
                                        No users yet.
                                        <a href="{{ route('proprietor.users.create') }}">Create the first one.</a>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
