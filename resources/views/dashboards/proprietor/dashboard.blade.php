            ...
            <div class="card border-0 shadow-sm rounded-3 h-100">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="badge bg-success bg-opacity-10 rounded-pill" style="font-size:11px;">This Term</span>
                    </div>
        ...
        <div class="col-12 col-lg-6">
            <div class="card border-0 shadow-sm rounded-3 h-100">
                <div class="card-header bg-white border-bottom d-flex align-items-center justify-content-between py-3">
                    ...
                    <a href="{{ route('admin.payments.index') }}" class="text-primary" style="font-size:13px;">View all &rarr;</a>
                </div>
                <div class="card-body p-0">
                    ...
                    <div class="d-flex align-items-center gap-3 px-4 py-3 border-bottom">
                        <div class="rounded-circle bg-success bg-opacity-10 text-success d-flex align-items-center justify-content-center fw-bold flex-shrink-0"
                            ...
                            {{ strtoupper(substr($payment->student->first_name ?? 'S', 0, 1)) }}
                        </div>
