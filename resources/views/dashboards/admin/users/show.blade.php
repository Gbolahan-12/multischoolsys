            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="card border-0 shadow-sm rounded-3 mb-4 text-center">
                    <div class="card-body p-4">
                        ...
                        {{-- Avatar --}}
                        {{-- <div
                            class="mx-auto rounded-circle bg-primary bg-opacity-10 text-white d-flex align-items-center justify-content-center fw-bold mb-3"
                    ...
                    <div class="card-body p-0">
                        <dl class="mb-0">
                            <div class="row g-0 px-4 py-3 border-bottom align-items-center">
                                ...
                                <dd class="col-7 col-sm-8 mb-0 fw-semibold" style="font-size:14px;">{{ $user->fullname }}
                                </dd>
                            </div>
                            <div class="row g-0 px-4 py-3 border-bottom align-items-center">
                            ...
                            <div class="row g-0 px-4 py-3 border-bottom align-items-center">
                                ...
                                <dd class="col-7 col-sm-8 mb-0">
                                    <span
                                        class="badge rounded-pill {{ $user->role === 'admin' ? 'text-bg-warning' : 'text-bg-info' }}">
                                        {{ ucfirst($user->role) }}
                                    </span>
                                </dd>
                            </div>
