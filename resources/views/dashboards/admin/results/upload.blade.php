    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-lg-5">
            ...
            <div class="card border-0 shadow-sm rounded-3">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.results.upload') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <a href="{{ route('admin.results.download-template', ['class_id' => $class->id, 'subject_id' => $subject->id, 'component' => 'ca1']) }}"
                           class="btn btn-outline-secondary btn-sm">
                            <i class="bi bi-download me-1"></i> CA1 Template
                        </a>
                        <a href="{{ route('admin.results.download-template', ['class_id' => $class->id, 'subject_id' => $subject->id, 'component' => 'ca2']) }}"
                           class="btn btn-outline-secondary btn-sm">
                            <i class="bi bi-download me-1"></i> CA2 Template
                        </a>
                        <a href="{{ route('admin.results.download-template', ['class_id' => $class->id, 'subject_id' => $subject->id, 'component' => 'exam']) }}"
                           class="btn btn-outline-secondary btn-sm">
        ...
        <div class="col-12 col-lg-7">
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-header bg-white border-bottom py-3 d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('admin.results.view', ['class_id' => $class->id, 'subject_id' => $subject->id]) }}"
