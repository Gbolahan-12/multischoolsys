                                            ...
                                            <form class="forms-sample" method="POST" action="{{ route('register') }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        id="exampleInputUsername1" autocomplete="SchoolName"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control"
                                                        value="{{ old('school_email') }}" name="school_email"
                                                        id="exampleInputUsername1" autocomplete="SchoolEmail"
                                                        placeholder="School Email">
                                                    <x-input-error :messages="$errors->get('school_email')"
                                                        class="mt-2" />
