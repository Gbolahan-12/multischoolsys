...
<head>
	...
	<title>@yield('title', 'Proprietor') — Dashboard</title>
	...
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
			@if(session('subscription_warning'))
				<div class="alert alert-warning rounded-0 mb-0 py-2 text-center" style="font-size:13px;">
					<i class="bi bi-exclamation-triangle-fill me-2"></i>
					{{ session('subscription_warning') }}
					<a href="https://wa.me/2348000000000" target="_blank" class="btn btn-sm btn-warning ms-2 py-0">
						<i class="bi bi-whatsapp me-1"></i>Renew Now
					</a>
				</div>
			@endif

			<!-- partial:partials/_navbar.html -->
			@include('includes.proprietor.header')
			...
			@include('includes.proprietor.footer')
			<!-- partial -->
