    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('proprietor.sessions.*') || request()->routeIs('admin.students.import.*') ? '' : 'collapsed' }}"
          data-toggle="collapse" href="#emails" role="button"
        ...
        <div
          class="collapse {{ request()->routeIs('proprietor.sessions.*') || request()->routeIs('admin.students.import.*') ? 'show' : '' }}"
          id="emails">
      ...
      <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('admin.payments.*') || request()->routeIs('admin.paid-students.*') ? '' : 'collapsed' }}"
          data-toggle="collapse" href="#uiComponents" role="button"
        ...
        <div
          class="collapse {{ request()->routeIs('admin.payments.*') || request()->routeIs('admin.paid-students.*') ? 'show' : '' }}"
          id="uiComponents">
          <ul class="nav sub-menu">
      ...
      <li class="nav-item">
        ...
        <div
          class="collapse {{ request()->routeIs('admin.classes.*') || request()->routeIs('admin.class.fees') ? 'show' : '' }}"
          id="advancedUI">
          <ul class="nav sub-menu">
