    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown nav-profile">
        <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-toggle="dropdown"
          aria-haspopup="true" aria-expanded="false">
          <img src="{{ asset(auth()->user()->profile?->avatar ?? 'profile-images/default-avatar.jpg') }}"
     ...
     class="rounded-circle" style="width:36px;height:36px;object-fit:cover;">
            ...
            <div class="info text-center">
              <p class="name font-weight-bold mb-0">{{ Auth::user()->fullname }}</p>
          ...
          <div class="dropdown-body">
            <ul class="profile-nav p-0 pt-3">
              ...
              @if (auth()->user()->role === 'proprietor')
                  <li class="nav-item">
                <a href="{{ route('proprietor.school-profile.show') }}" class="nav-link">
                  <i data-feather="user"></i>
